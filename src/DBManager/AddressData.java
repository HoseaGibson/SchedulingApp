...
/**
 *  Address class to insert and retrieve data into mysql database
 */
public class AddressData {
    ...
    public static int addAddress(Address address) {
        ...
        try {
            ...
            stmt.setString(7, Loggers.getUserName());
            stmt.setString(8, Loggers.getUserName());
            stmt.executeUpdate();
        }
        catch (SQLException e) {
        }
    ...
    public static void updateAddress(Address address) {
        ...
        try{
            ...
            stmt.setString(6, Loggers.getUserName());
